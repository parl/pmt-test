<template>
  ...
  <div class="row g-5 g-xl-8">
    ...
    <!--begin::Col-->
    <div class="col-xl-6">
      <TablesWidget2 widget-classes="card-xl-stretch mb-5 mb-xl-8"></TablesWidget2>
    </div>
    <!--end::Col-->
  </div>
  <!--end::Row-->
  ...
  <div class="row g-5 g-xl-8">
    ...
    <!--begin::Col-->
    <div class="col-xl-6">
      <TablesWidget4 widget-classes="card-xl-stretch mb-5 mb-xl-8"></TablesWidget4>
    </div>
    <!--end::Col-->
  </div>
  <!--end::Row-->
  ...
  <div class="row g-5 g-xl-8">
    ...
    <!--begin::Col-->
    <div class="col-xl-6">
      <TablesWidget6 widget-classes="card-xl-stretch mb-5 mb-xl-8"></TablesWidget6>
    </div>
    <!--end::Col-->
  </div>
  <!--end::Row-->
  ...
  <div class="row g-5 g-xl-8">
    ...
    <!--begin::Col-->
    <div class="col-xl-6">
      <TablesWidget8 widget-classes="card-xl-stretch mb-5 mb-xl-8"></TablesWidget8>
    </div>
    <!--end::Col-->
  </div>
  <!--end::Row-->

  <ManageTransactionTable widget-classes="mb-5 mb-xl-8"></ManageTransactionTable>
...
import ManageTransactionTable from "@/components/widgets/tables/ManageTransactions.vue";
